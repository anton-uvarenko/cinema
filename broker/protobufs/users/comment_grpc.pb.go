...
type CommentsClient interface {
	...
	GetComments(ctx context.Context, in *users.Empty, opts ...grpc.CallOption) (*CommentsResponse, error)
	LikeComment(ctx context.Context, in *LikeCommentPayload, opts ...grpc.CallOption) (*users.Empty, error)
}
...
func (c *commentsClient) GetComments(ctx context.Context, in *users.Empty, opts ...grpc.CallOption) (*CommentsResponse, error) {
...
func (c *commentsClient) LikeComment(ctx context.Context, in *LikeCommentPayload, opts ...grpc.CallOption) (*users.Empty, error) {
	out := new(users.Empty)
...
type CommentsServer interface {
	...
	GetComments(context.Context, *users.Empty) (*CommentsResponse, error)
	LikeComment(context.Context, *LikeCommentPayload) (*users.Empty, error)
...
func (UnimplementedCommentsServer) GetComments(context.Context, *users.Empty) (*CommentsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetComments not implemented")
}
func (UnimplementedCommentsServer) LikeComment(context.Context, *LikeCommentPayload) (*users.Empty, error) {
...
func _Comments_GetComments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommentsServer).GetComments(ctx, req.(*users.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
